...
using client_api.Core;
using client_api.Core.Middlewares;
using core;
using core.Auth;
...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "Git8Git Client API", Version = "v1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Git8Git Client API v1");
        c.RoutePrefix = "docs";
    });
}
